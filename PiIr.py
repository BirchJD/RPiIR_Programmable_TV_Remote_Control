...
# PiIr - Infra Red Data Reciever Monitor
...
#/****************************************************************************/
#/* PiIr.py - Infra Red Data Reciever Monitor.                               */
#/* ------------------------------------------------------------------------ */
#/* V1.00 - 2019-09-12 - Jason Birch                                         */
#/* ------------------------------------------------------------------------ */
#/* Script for monitoring Infra Ref and displaying packets of data received. */
#/****************************************************************************/
...
while ExitFlag == False:
   ...
   if len(ThisRxPacket.Data) == 0 or DiffPeriod < RX_END_PERIOD:
      ...
      if BadDataFlag == False or (BadDataFlag == True and LOG_BAD_DATA == True):
         ...
         LogFile = open("LOG/{:s}_IR.log".format(Now.strftime("%Y-%m-%d")), 'a', 0)

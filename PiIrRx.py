...
# PiIrRx - Infra Red Data Reciever and Decoder
...
#/****************************************************************************/
#/* PiIrRx.py - Infra Red Data Reciever and Decoder.                         */
#/* ------------------------------------------------------------------------ */
#/* V1.00 - 2019-09-12 - Jason Birch                                         */
#/* ------------------------------------------------------------------------ */
#/* Script for receiving data provided on an Infra Red VS1838B device.       */
#/*                                                                          */
